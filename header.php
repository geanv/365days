...
<head>
    ...
    <link rel="icon" href="<?php $this->options->themeUrl('img/favicon.png'); ?>" type="image/x-icon" />
    <link rel="shortcut icon" href="<?php $this->options->themeUrl('img/favicon.png'); ?>" type="image/x-icon" />
        ...
        <div class="row">
            ...
            <div class="col-mb-9 col-7">
                <nav id="nav-menu" class="clearfix" role="navigation">
                    <a<?php if($this->is('index')): ?> class="current"<?php endif; ?> href="<?php $this->options->siteUrl(); ?>"><?php _e('博客'); ?></a>
