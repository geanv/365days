...
function themeConfig($form) {
    ...
    $tableContent = new Typecho_Widget_Helper_Form_Element_Checkbox('tableContent', 
        array('ShowTableContent' => _t('在文章页面使用目录代替其它侧边内容')),
        array('ShowTableContent'), _t('显示文章目录'));    
    $form->addInput($tableContent->multiMode());
}
...
function tableContent() {
    if (class_exists('ContentIndex_Plugin') && isset(ContentIndex_Plugin::$toc)) {
        ContentIndex_Plugin::tableContent();
    }
}
